defmodule SampsonCookbookWeb.RecipeControllerTest do
  use SampsonCookbookWeb.ConnCase

  alias SampsonCookbook.Book

  @create_attrs %{est_time: 42, name: "some name", tags: []}
  @update_attrs %{est_time: 43, name: "some updated name", tags: []}
  @invalid_attrs %{est_time: nil, name: nil, tags: nil}

  def fixture(:recipe) do
    {:ok, recipe} = Book.create_recipe(@create_attrs)
    recipe
  end
